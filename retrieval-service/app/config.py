...
class Settings:
    ...
    siliconapeclub_server_base_url = os.getenv(
        "SILICONAPECLUB_SERVER_BASE_URL",
        os.getenv("DOCSPACE_SERVER_BASE_URL", "http://localhost:8080"),
    )
    service_token = os.getenv("RETRIEVAL_SERVICE_TOKEN", "siliconapeclub-retrieval-dev-token")
