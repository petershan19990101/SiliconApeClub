...
const FALLBACK_MENUS: SystemMenuNode[] = [
  ...
  { id: 'library', code: 'library.view', name: '文档库', type: 'page', routeKey: 'library', icon: 'library', sortOrder: 20, enabled: true, children: [] },
  { id: 'search', code: 'search.view', name: '全局搜索', type: 'page', routeKey: 'search', icon: 'search', sortOrder: 30, enabled: true, children: [] },
  { id: 'wiki', code: 'wiki.view', name: '知识 Wiki', type: 'page', routeKey: 'wiki', icon: 'book-open', sortOrder: 45, enabled: true, children: [] },
  { id: 'position_packages', code: 'position_package.view', name: '岗位知识包', type: 'page', routeKey: 'position_packages', icon: 'briefcase', sortOrder: 50, enabled: true, children: [] },
  { id: 'knowledge_health', code: 'knowledge_health.view', name: '知识健康', type: 'page', routeKey: 'knowledge_health', icon: 'activity', sortOrder: 55, enabled: true, children: [] },
  { id: 'rag_debug', code: 'rag_debug.view', name: 'RAG 调试台', type: 'page', routeKey: 'rag_debug', icon: 'search', sortOrder: 60, enabled: true, children: [] },
  { id: 'ai_employees', code: 'ai_employee.view', name: 'AI 员工', type: 'page', routeKey: 'ai_employees', icon: 'users', sortOrder: 65, enabled: true, children: [] },
  ...
  return (
    <aside className="flex h-full w-64 flex-col bg-slate-900 text-slate-400">
      <div className="flex items-center gap-3 p-6">
        <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-blue-600 text-lg font-black text-white">D</div>
        <div>
          <p className="text-lg font-bold tracking-tight text-white">DocSpace</p>
          <p className="text-[10px] font-medium uppercase tracking-[0.3em] text-slate-500">Knowledge Flow</p>
        </div>
      </div>
