    ...
    <>
      <div className="px-8 pb-4 pt-8">
        ...
        <div className="flex items-end justify-between">
          <div>
            <h1 className="text-2xl font-bold tracking-tight text-slate-900">{currentFolder ? currentFolder.name : '知识文档库'}</h1>
            <p className="mt-1 text-sm text-slate-500">
              {currentFolder ? '当前目录下展示子目录与文档内容，点击面包屑可快速返回上级。' : '统一管理上传、校正、审核、发布与修订中的知识文档。'}
            </p>
          </div>
