      ...
      <div className="grid w-full max-w-5xl overflow-hidden rounded-[40px] border border-white/70 bg-white/90 shadow-[0_30px_80px_rgba(15,23,42,0.12)] backdrop-blur lg:grid-cols-[1.1fr_0.9fr]">
        <section className="bg-slate-950 px-10 py-12 text-white">
          <div className="mb-10 flex items-center gap-4">
            <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-blue-600 text-2xl font-black">S</div>
            <div>
              <h1 className="text-2xl font-bold tracking-tight">硅基猿猴俱乐部</h1>
              <p className="text-xs uppercase tracking-[0.4em] text-slate-400">Management Console</p>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <h2 className="mt-4 text-4xl font-black leading-tight">AI 员工与知识资产管理台</h2>
              <p className="mt-4 max-w-md text-sm leading-7 text-slate-300">
                登录后即可配置 AI 员工、运营知识资产、维护 Wiki/RAG 闭环，并基于当前账号身份与权限控制关键动作。
              </p>
            </div>
